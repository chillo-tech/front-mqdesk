...
function Offre(props: Props) {
	return (
		<section className="py-10 md:py-20 text-lg text-light">
			...
			<div className="container flex items-center justify-center">
				<Link
					href="/sign-up"
					className="block bg-app-blue text-slate-50 text-lg md:text-xl front-bolder py-3 md:px-10 px-8 rounded-full inline-block"
				>
