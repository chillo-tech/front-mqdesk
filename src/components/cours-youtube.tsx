...
function CoursYoutube({}: Props) {
	return (
		<section>
			<div className="container grid md:grid-cols-2 items-center md:py-12">
				<div className="flex flex-col gap-3 items-center md:items-start px-2 py-10 md:p-0">
					<h2 className={`${montserrat.className} text-2xl font-bold text-app-blue`}>
					...
					<Link
						...
						className="md:mt-6 text-app-blue front-bolder border-b border-app-blue"
						target="_blank"
					>
						Regarder la vidéo
					</Link>
